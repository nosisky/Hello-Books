					...
					<div className="row">
						<div className="col l6 s12">
							...
							<p className="grey-text text-lighten-4">
								Hello-Books is a simple application that helps manage a library and its processes like
								stocking, tracking and renting books. With this application users are able to find and
								rent books.
							</p>
						</div>
